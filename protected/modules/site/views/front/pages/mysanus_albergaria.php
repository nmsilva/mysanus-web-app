<div class="destaques">
    <img src="<?php echo $this->module->assetsUrl; ?>/images/mysanus_albergaria.png" />
</div>

<?php 
$model = CategoriaIdioma::model()->find('ID_CAT=:id AND LANG_ID=:lang', array('id'=>'7','lang'=>$this->lang));
...
<?php 
$_tab1=ArtigoIdioma::model()->find('OBJETO_ID=:id AND LANG_ID=:lang', array('id'=>'18','lang'=>$this->lang));
...
<?php if($_tab1 && $_tab2 && $_tab3 && $_tab4): ?>
    <div class="main-tabs one">
        ...
        'tabs'=>array(
            'tab1'=>array(
                'title'=>$_tab1->TITULO,
                'view'=>'pages/albergaria/tab1'
            ),
            'tab2'=>array(
                'title'=>$_tab2->TITULO,
                'view'=>'pages/albergaria/tab2'
            ),
            'tab3'=>array(
                'title'=>$_tab3->TITULO,
                'view'=>'pages/albergaria/tab3'
            ),
            'tab4'=>array(
                'title'=>$_tab4->TITULO,
                'view'=>'pages/albergaria/tab4'
            )
        ),
        'htmlOptions'=>array(
            'class'=>'tabs-content'
