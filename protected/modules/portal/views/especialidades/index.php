<div class="widget">
    <div class="header">
        ...
        <?php $this->widget('bootstrap.widgets.TbButton', array(
            'label'=>t('Adicionar Especialidade'),
            'size'=>'small',
            'url'=> $this->createUrl($this->id.'/create'),
        )); ?>
        
        <?php $this->widget('bootstrap.widgets.TbButton', array(
            'label'=>t('Gerir Áreas de Especialidades'),
            'size'=>'small',
            'url'=> $this->createUrl('/portal/tiposespecialidade'),
        )); ?>
    </div>
    <div class="content"> 
              ...
              <input type="text" id="q" name="Especialidade[NOME]" class="search" style="width: 96.8%; "/>
