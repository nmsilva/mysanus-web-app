...
class FounActiveForm extends CActiveForm {
    ...
    public function inputRow( $type, $model, $attribute, $data = null, $htmlOptions = array() ) {
        return Yii::app( )->controller->widget( 'FounInput', array(
            'type' => $type,
            'form' => $this,
            'model' => $model,
            'attribute' => $attribute,
     ...
     * @param CModel $model the data model
     * @param string $attribute the attribute
     * @param array $data value-label pairs used to generate the radio button
     * list.
     ...
     * @param boolean $checkbox flag that indicates if the list is a
     * checkbox-list.
     * @param CModel $model the data model
     * @param string $attribute the attribute
     ...
     * @param array $htmlOptions additional HTML attributes to be rendered in the
     * container div tag.
     * @param boolean $enableAjaxValidation whether to enable AJAX validation for
     * the specified attribute.
     * @param boolean $enableClientValidation whether to enable client-side
     * validation for the specified attribute.
    ...
    public static function getErrorHtml( $model, $attribute, $htmlOptions = array() ) {
        ...
        if( $error !== null )
            return CHtml::tag( 'small', $htmlOptions, $error );
        else
            return '';
    }
     ...
     * @param string $header a piece of HTML code that appears in front of the
     * errors
     * @param string $footer a piece of HTML code that appears at the end of the
     * errors
     * @param array $htmlOptions additional HTML attributes to be rendered in the
     * container div tag.
    ...
    public function errorSummary( $models, $header = null, $footer = null, $htmlOptions = array() ) {
        ...
        // Foundation error class as default
    ...
    public function fileFieldRow( $model, $attribute, $htmlOptions = array() ) {
        return $this->inputRow( FounInput::TYPE_FILE, $model, $attribute, null, $htmlOptions );
    }
    ...
    public function captchaRow( $model, $attribute, $htmlOptions = array(), $captchaOptions = array() ) {
        return $this->inputRow( FounInput::TYPE_CAPTCHA, $model, $attribute, $captchaOptions, $htmlOptions );
    }
